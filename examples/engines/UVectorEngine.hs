...
--	quickCheck $ testHermit 1000 ((50,50),False) acorn
	defaultMain
		[ bench "UVector-G-20x20" $ whnf (life 1000 ((20,20),True)) glider
		, bench "UVector-GG-50x50" $ whnf (life 1000 ((50,50),False)) gliderGun
		, bench "UVector-A-50x50" $ whnf (life 1000 ((50,50),False)) acorn
		]
