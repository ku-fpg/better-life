...
main :: IO ()
main = defaultMain
		[ bench "Glider20x20" $ whnf (life 1000 ((20,20),True)) glider
		, bench "GliderGun50x50" $ whnf (life 1000 ((50,50),False)) gliderGun
		, bench "Acorn50x50" $ whnf (life 1000 ((50,50),False)) acorn
		]
